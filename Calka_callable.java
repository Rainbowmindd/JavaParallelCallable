...
//public class Calka_callable{
    ...
    private double xp;
    private double xk;
    private int N; //liczba podzialow przedzialu calkowania na mniejsze kawalki
    ...
    @Override
    public Double call() throws Exception { //klasa calka_callable implementuje interfejs Callable<Double> -> zadanie jest reprezentowane przez obiekt tej klasy
        return compute_integral();
    }
     //umozliwia wspolprace z pula watkow
